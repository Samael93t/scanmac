...
Dosyab="/sdcard/hits/Ⓜ️🅰️©️ FRIENDS VIP"                      +panel.replace(":","_").replace('/','') +".txt"                           
say=1
def yax(hits):
    dosya=open(Dosyab,'a+') 
    dosya.write(hits)
...
*`•.¸(¯`•.•´¯)¸.•´ ♥
☆ º ♥ `•.¸.•´ ♥ º ☆.¸¸.•´¯`♥
\33[32mInfo hits🌟 \33[36m """+str(hitc)+""" 🌟 🇭 🇮 🇹  🌟  """   +str(hitr)+""" 
\33[36m¯`•.•´¯) (¯`•.•´¯)
*`•.¸(¯`•.•´¯)¸.•´ ♥
☆ º ♥ `•.¸.•´ ♥ º ☆.¸¸.•´¯`♥ 
\33[33mMAC LINK
...
♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣             
\33[35mMAC SCANN
 """+tokenr+str(mac)+"""\33[33m CPM☞ """+str(cpm)+"""  \33[32m    
¯`•.•´¯) (¯`•.•´¯)
*`•.¸(¯`•.•´¯)¸.•´ ♥
☆ º ♥ `•.¸.•´ ♥ º ☆.¸¸.•´¯`♥
♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣          
\33[36mINFO
"""  +str(bot)+""" \33[36mTotal☞"""+str(total)+"""   \33[94m\33[31m%"""  +str(oran)+""" 
\33[35m¯`•.•´¯) (¯`•.•´¯)
*`•.¸(¯`•.•´¯)¸.•´ ♥
☆ º ♥ `•.¸.•´ ♥ º ☆.¸¸.•´¯`♥
♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣            
